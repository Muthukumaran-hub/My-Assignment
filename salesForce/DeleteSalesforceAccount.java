...
public class DeleteSalesforceAccount {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@name='Account-search-input']")).sendKeys("M Kumaran",Keys.ENTER);
		Thread.sleep(3000);
		driver.findElement(By.xpath("//a[text()='M Kumaran']")).click();
